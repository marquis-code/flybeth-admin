      ...
      <UiBaseCard padding class="!bg-brand-blue text-white overflow-hidden relative group">
        ...
        <div class="mt-8 flex items-center justify-between">
           <div class="flex flex-col">
              ...
              <span class="text-lg font-bold text-brand-green ">$360,873</span>
           </div>
    ...
    <UiBaseCard>
      <div class="px-8 py-6 border-b border-gray-50 flex flex-col md:flex-row md:items-center justify-between gap-4">
        ...
        <div class="flex items-center space-x-4">
           ...
           <UiBaseButton variant="ghost" size="sm" class="!px-4 !py-2 border border-gray-100 font-bold text-sm   hover:bg-gray-50">Filter</UiBaseButton>
        </div>
      </div>
        ...
        <table class="w-full text-left border-collapse">
          ...
          <tbody class="divide-y divide-gray-50">
            <tr v-for="tx in transactions" :key="tx.id" class="hover:bg-brand-blue/[0.01] transition-all duration-300 group">
              ...
              <td class="px-8 py-6 font-bold text-gray-900 text-sm ">${{ tx.amount }}</td>
              <td class="px-8 py-6 text-sm font-bold text-gray-600">{{ tx.rate }}%</td>
              <td class="px-8 py-6 font-bold text-brand-green text-sm ">${{ tx.payout }}</td>
              <td class="px-8 py-6">
