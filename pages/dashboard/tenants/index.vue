...
<UiBaseCard padding class="!py-4 !overflow-visible" style="overflow: visible !important;">
  <div class="flex flex-col lg:flex-row gap-6 items-center" style="overflow: visible;">
    ...
    <!-- Tenants Table -->
    <div v-if="loading && tenants.length === 0" class="flex flex-col items-center justify-center py-20 bg-white rounded-3xl border border-gray-200">
    ...
    >
      ...
      <template #cell(actions)="{ item }">
        <div class="flex items-center justify-end space-x-2">
          <button @click="navigateTo(`/dashboard/tenants/${item._id}`)" class="h-9 w-9 flex items-center justify-center rounded-xl bg-gray-50 text-gray-500 transition-colors hover:text-gray-900 hover:bg-brand-blue/5">
