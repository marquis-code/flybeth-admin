  ...
  <div class="space-y-8 pb-12">
    ...
    <div class="flex flex-col md:flex-row md:items-center justify-between gap-6">
      <div class="flex items-center space-x-6">
        <button @click="navigateTo('/dashboard/tenants')" class="h-10 w-10 flex items-center justify-center rounded-xl bg-gray-50 text-gray-500 hover:bg-white hover:shadow-none transition-all border border-gray-200 hover:border-gray-200">
    ...
    <div class="border-b border-gray-200">
      <nav class="-mb-px flex space-x-8">
        <button
          ...
          :class="activeTab === tab.id ? 'border-gray-900 text-gray-900' : 'border-gray-200 text-gray-500 hover:text-gray-700 hover:border-gray-300'"
        >
          {{ tab.name }}
        </button>
      </nav>
    ...
    <div class="mt-8">
      ...
      <div v-if="activeTab === 'compliance'" class="grid lg:grid-cols-2 gap-8">
        ...
        <UiBaseCard padding title="Legal Business Documentation">
           <div class="grid gap-6 pt-4">
             <div class="p-6 bg-white border-2 border-gray-200 rounded-3xl flex items-center justify-between shadow-none">
                <div class="flex items-center space-x-6">
             ...
             <div>
                <p class="text-xs font-medium text-gray-500 leading-relaxed bg-gray-50 p-4 rounded-xl border border-gray-200">
      ...
      <div v-if="activeTab === 'finance'" class="grid lg:grid-cols-2 gap-8">
         <div class="bg-gray-900 text-white overflow-hidden relative rounded-3xl p-8 shadow-none">
        ...
        <div class="space-y-8">
           <UiBaseCard padding title="Revenue Analytics">
             <div class="p-8 flex flex-col items-center justify-center space-y-4 border-2 border-dashed border-gray-200 rounded-3xl min-h-[200px] bg-gray-50">
