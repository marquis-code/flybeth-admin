<template>
  <div class="p-6 lg:p-10 space-y-8">
    ...
    <div class="flex flex-col md:flex-row md:items-center justify-between gap-6">
      ...
      <div class="flex items-center gap-2 p-1 bg-gray-100 rounded-xl w-fit">
        <button 
          ...
          :class="activeTab === t.id ? 'bg-white text-gray-900 shadow-none' : 'text-gray-400 hover:text-gray-600'"
        >
          {{ t.label }}
        </button>
      </div>
    ...
    <!-- ── Live Chats Tab ── -->
    <div v-if="activeTab === 'live_chats'" class="relative h-[80vh] min-h-[600px] bg-white rounded-none border border-gray-200 shadow-none overflow-hidden">
      <SupportChatInterface />
    </div>

    <!-- ── Newsletter Tab ── -->
    <div v-if="activeTab === 'newsletter'" class="bg-white rounded-none border border-gray-200 shadow-none overflow-hidden">
    ...
    <!-- ── Inquiries Tab ── -->
    <div v-if="activeTab === 'inquiries'" class="bg-white rounded-none border border-gray-200 shadow-none overflow-hidden">
      <div class="p-6 border-b border-gray-200 flex items-center justify-between">
    ...
    <div v-if="selectedInquiry" class="fixed inset-0 z-50 flex items-center justify-center p-6 bg-black/60 backdrop-blur-sm">
      <div class="bg-white rounded-[2.5rem] w-full max-w-2xl overflow-hidden shadow-none animate-in fade-in zoom-in duration-300">
        <div class="p-8 lg:p-10 border-b border-gray-200 flex items-center justify-between">
...
const activeTab = ref('live_chats')
const selectedInquiry = ref<any>(null)
const tabs = [
  { id: 'live_chats', label: 'Live Chats' },
  { id: 'inquiries', label: 'Inquiries' },
  { id: 'newsletter', label: 'Subscriptions' }
]

import SupportChatInterface from '@/components/SupportChatInterface.vue'
