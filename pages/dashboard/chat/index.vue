          ...
          <div class="flex flex-col z-30 shrink-0 border-t border-[#d1d7db]">
            ...
            <div class="px-3 py-2.5 bg-[#f0f2f5] flex items-center gap-2">
               <div class="relative flex items-center shrink-0">
                  ...
                  <div v-if="showEmojiPicker" class="absolute bottom-full mb-4 left-0 bg-white rounded-lg shadow-none p-4 grid grid-cols-6 gap-2 w-72 z-[100] border border-[#d1d7db]">
