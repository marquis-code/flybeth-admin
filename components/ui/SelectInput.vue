    ...
    <div class="mb-2">
      <div class="relative input-container" ref="containerRef">
        ...
        <div
          ...
          :class="[
            'w-full py-4 pt-6 px-3 bg-gray-50 border-[0.5px] border-gray-200 flex justify-between items-center cursor-pointer',
        ...
        <div
          v-if="showDropdown"
          class="absolute z-[99999] mt-1 w-full bg-white border border-gray-200 rounded-2xl overflow-hidden"
        >
          <!-- Search Input -->
